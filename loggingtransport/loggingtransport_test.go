...
func TestLoggingClient_200_OK_WithHeadersAndBodies(t *testing.T) {
	...
	var lvl loggingclient.Level
	for lvl = loggingclient.Discrete; lvl <= loggingclient.WithHeadersAndBodies; lvl++ {
...
`)
		...
		logger := func(item *loggingclient.LogItem) {
			...
			if lvl == loggingclient.WithHeadersAndBodies {
...
func TestLoggingClient_200_OK_Levels(t *testing.T) {
	...
	cases := map[loggingclient.Level]string{
		loggingclient.Discrete:             "http://somewhere.com/a/b/c",
		loggingclient.Summary:              "http://somewhere.com/a/b/c?foo=1&bar=2",
		loggingclient.WithHeaders:          "http://somewhere.com/a/b/c?foo=1&bar=2",
		loggingclient.WithHeadersAndBodies: "http://somewhere.com/a/b/c?foo=1&bar=2",
	}
